  ...
  return function handlePptxProxy(req, res) {
    ...
    collectRequestBody(req, maxBodyBytes, async ({ body, error, tooLarge }) => {
      ...
      try {
        ...
        if (backendPath === "/healthz" && upstream.ok) {
          ...
          sendJson(res, 200, {
            ...
            proxy: {
              ...
              runtime: "node",
              release,
              backend_protocol: new URL(normalizedBackend).protocol.replace(":", ""),
            },
          }, {
        ...
        responseHeaders["x-surveykit-service"] = "surveykit-pptx-proxy";
        responseHeaders["x-surveykit-release"] = releaseInfo().version;
