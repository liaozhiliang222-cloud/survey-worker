...
const INTERVIEW_GUIDE_STRUCTURE_RULE = "不得使用问卷式字母数字题号（如 A1、A2、B1）；必须使用章节或模块标题组织内容，并仅使用简单的分段标记。";
...
function taskInstruction(taskType, artifactType = "") {
  ...
  return taskType === "artifact_revision" && artifactType === "interview_guide" ? `${instruction}${INTERVIEW_GUIDE_STRUCTURE_RULE}` : instruction;
}
