...
assert.match(app, /const AI_REPORT_STAGE_CACHE_KEY = "surveykit_ai_report_stage_cache_v1"/);
assert.match(app, /上一版故事线已保留/);
...
assert.match(app, /再次生成将只续跑缺失页面/);
assert.match(app, /clearAiReportStageCache/);
