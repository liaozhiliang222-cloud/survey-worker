...
function excelWorkbookStylesXml() {
  return `<Styles>
    ...
    <Style ss:ID="CrosstabBase"><Alignment ss:Horizontal="Center" ss:Vertical="Center"/><Borders><Border ss:Position="Left" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/><Border ss:Position="Right" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/><Border ss:Position="Top" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/><Border ss:Position="Bottom" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/></Borders><Font ss:FontName="Arial" ss:Size="10" ss:Bold="1" ss:Color="#375623"/><Interior ss:Color="#E2F0D9" ss:Pattern="Solid"/></Style>
