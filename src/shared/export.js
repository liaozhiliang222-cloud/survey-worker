...
function excelWorkbookStylesXml() {
  return `<Styles>
    ...
    <Style ss:ID="CrosstabHeaderTop"><Alignment ss:Horizontal="Center" ss:Vertical="Center" ss:WrapText="1"/><Borders><Border ss:Position="Left" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/><Border ss:Position="Right" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/><Border ss:Position="Top" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/><Border ss:Position="Bottom" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/></Borders><Font ss:FontName="Microsoft YaHei" ss:Size="10" ss:Bold="1" ss:Color="#FFFFFF"/><Interior ss:Color="#4472C4" ss:Pattern="Solid"/></Style>
    <Style ss:ID="CrosstabHeaderMid"><Alignment ss:Horizontal="Center" ss:Vertical="Center" ss:WrapText="1"/><Borders><Border ss:Position="Left" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/><Border ss:Position="Right" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/><Border ss:Position="Top" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/><Border ss:Position="Bottom" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/></Borders><Font ss:FontName="Microsoft YaHei" ss:Size="10" ss:Bold="1" ss:Color="#17365D"/><Interior ss:Color="#9DC3E6" ss:Pattern="Solid"/></Style>
    <Style ss:ID="CrosstabHeaderBottom"><Alignment ss:Horizontal="Center" ss:Vertical="Center" ss:WrapText="1"/><Borders><Border ss:Position="Left" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/><Border ss:Position="Right" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/><Border ss:Position="Top" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/><Border ss:Position="Bottom" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#526A82"/></Borders><Font ss:FontName="Microsoft YaHei" ss:Size="9" ss:Bold="1" ss:Color="#17365D"/><Interior ss:Color="#D9EAF7" ss:Pattern="Solid"/></Style>
...
function excelXlsxSheetXml(sheet) {
  ...
  const rows = (sheet.rows || []).map((row, rowIndex) => {
    ...
    const cellXml = cells.map((rawCell) => {
      ...
      const mergedHeaderXml = [8, 9, 10].includes(style)
